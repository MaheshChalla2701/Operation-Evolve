...
class EvolveConfig:
    ...
    # Model                                                                #
    # ------------------------------------------------------------------ #
    model_type: str = "HierarchicalMoE"     # "SimpleNN", "SimpleTransformer", "TransformerLM", "HierarchicalMoE"
    hidden_dim: int = 64             # Hidden layer size for SimpleNN
    d_model: int = 64                # Equivalent to n_embd
    num_heads: int = 4               # Attention heads for Transformers
    num_layers: int = 2              # Transformer encoder layers
    experts: int = 1                 # Standard MoE experts
    
    # Hierarchical MoE Specific Configs
